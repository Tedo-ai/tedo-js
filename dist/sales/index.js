...
export class SalesService {
    ...
    async createStage(pipelineId, params) {
        return this.req("POST", "/sales/v1/stages", { pipeline_id: pipelineId, ...params });
    }
    ...
    async listLeads(params) {
        ...
        if (params?.pipeline_id)
            query.pipeline_id = params.pipeline_id;
        return this.req("GET", "/sales/v1/leads", undefined, Object.keys(query).length ? query : undefined);
    }
    /** Get a lead by ID. */
    async getLead(id) {
    ...
    async listDeals(params) {
        ...
        if (params?.pipeline_id)
            query.pipeline_id = params.pipeline_id;
        return this.req("GET", "/sales/v1/deals", undefined, Object.keys(query).length ? query : undefined);
    }
    /** Get a deal by ID. */
    async getDeal(id) {
    ...
    async listActivities(params) {
        ...
        return this.req("GET", "/sales/v1/activities", undefined, Object.keys(query).length ? query : undefined);
    }
    ...
    async listNotes(params) {
        ...
        if (params?.deal_id)
            query.deal_id = params.deal_id;
        return this.req("GET", "/sales/v1/notes", undefined, Object.keys(query).length ? query : undefined);
    }
    /** Get a note by ID. */
    async getNote(id) {
    ...
    async createPerson(contactBaseId, params) {
        return this.req("POST", `/sales/v1/contact-bases/${contactBaseId}/persons`, params);
    }
    /** List all persons in a contact base. */
    async listPersons(contactBaseId) {
        return this.req("GET", `/sales/v1/contact-bases/${contactBaseId}/persons`);
    }
    /** Get a person by ID. */
    async getPerson(id) {
    ...
    async createOrganization(contactBaseId, params) {
        return this.req("POST", `/sales/v1/contact-bases/${contactBaseId}/organizations`, params);
    }
    /** List all organizations in a contact base. */
    async listOrganizations(contactBaseId) {
        return this.req("GET", `/sales/v1/contact-bases/${contactBaseId}/organizations`);
    }
    ...
    async updateOrganization(id, params) {
        return this.req("PATCH", `/sales/v1/organizations/${id}`, params);
    }
